...
handler.before = async function (m, {
   ...
   if (m.quoted && /ao untuk bantuan/i.test(m.quoted.text) && !m.fromMe) {
      if (!(id in conn.asahotak) && /ao untuk bantuan/i.test(m.quoted.text)) return m.reply('Soal itu telah berakhir')
