let handler = async (m, { conn, args, usedPrefix, Func }) => {
   ...
   switch (type) {
      case 'rubah':
         ...
         let waktur = Func.toTime(_waktur)
      ...
      case 'kuda':
         ...
         let waktuk = Func.toTime(_waktuk)
      ...
      case 'serigala':
         ...
         let waktus = Func.toTime(_waktus)
      ...
      case 'naga':
         ...
         let waktug = Func.toTime(_waktug)
      ...
      case 'kyubi':
         ...
         let waktuyu = Func.toTime(_waktuyu)
      ...
      case 'centaur':
         ...
         let waktuur = Func.toTime(_waktuur)
      ...
      case 'phonix':
         ...
         let waktux = Func.toTime(_waktux)
      ...
      case 'griffin':
         ...
         let waktufin = Func.toTime(_waktufin)
      ...
      case 'hero':
         ...
         let waktuher = Func.toTime(_waktuher)
