...
exports.makeWASocket = (connectionOptions, options = {}) => {
    ...
    conn.sendMessageModify = async (jid, text, quoted, properties, options = {}) => {
        ...
        if (properties.thumbnail) {
            var {
                file
            } = await conn.getFile(properties.thumbnail)
        }
        return conn.generateMessage(jid, {
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    title: properties.title || global.bdn,
                    body: properties.body || '',
                    mediaType: 1,
                    previewType: 0,
                    showAdAttribution: properties.ads && properties.ads ? true : false,
                    renderLargerThumbnail: properties.largeThumb && properties.largeThumb ? true : true,
                    thumbnail: properties.thumbnail ? await Func.getBuffer(file) : '',
                    //thumbnail: 'https://telegraph.ph/?id=' + Func.makeId(8),
                    //thumbnailUrl: 'https://telegra.ph/?id=' + Func.makeId(8) || properties.thumbnailUrl,
