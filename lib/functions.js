      ...
      return new Promise(async (resolve) => {
         try {
            let {
               ...
               file,
               mime
            } = await Func.getFile(await Func.fetchBuffer(source))
            ...
            NodeID3.write(tags, await Func.fetchBuffer(file), function(err, buffer) {
...
exports.getFile = (source, filename, referer) => {
    return new Promise(async (resolve) => {
      try {
